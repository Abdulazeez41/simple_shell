...
/**
 *  startDisplay - Display some info to the user at the start
 *
 *  @void: no return type
 */
...
/**
 * displayPrompt - Print out "MY_SHELL"
 *
 * @void: no return type
 */
...
/**
 * makeToken -  Divide input line into tokens
 *
...
/**
 * execute - a command to run a program
 *
